...
public class Window_level1 extends JPanel {
    ...
    public Window_level1(int width, int height, String title, Game game) {
        ...
        JFrame frameStartTheGame = new JFrame("The rules");
        frameStartTheGame.setPreferredSize(new Dimension(width+20, height));
        frameStartTheGame.setMinimumSize(new Dimension(width+20, height));
        frameStartTheGame.setMaximumSize(new Dimension(width+20, height));


        JPanel panelStartTheGame = new JPanel();
        panelStartTheGame.setLayout(new GridLayout(3,0));
        JLabel text1 = new JLabel("The rules");
        text1.setBorder(BorderFactory.createEmptyBorder(0, 200, 0,0));
        JLabel text2 = new JLabel("1. You can move using the arrow keys and shoot by pressing S");
        JLabel text3 = new JLabel("2. You have a gun with one bullet");
        JLabel text4 = new JLabel("3. The aim is to find the treasure without meeting the Wumpus or falling into the pit");
        JLabel text5 = new JLabel("4. Based on your level you can see more or less of the map");
        JLabel text6 = new JLabel("5. The wind is near the pit, the smell near the Wumpus and the lights near the treasure");
        JLabel text7 = new JLabel("6. This game has 4 levels. Enjoy and good luck!");
        JButton buttonStartTheGame = new JButton("Ok, I understand");
    ...
    public void postMessegeEndTheGame()
    {
        ...
        b2.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                frame.dispose();
                Window_level2 window2 =new Window_level2(500,500,"Level2",game);
                window2.putCharacters();
                window2.drawMap();
                window2.startTheGame();
            }
        });
        ...
        b3.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                frame.dispose();
                frameEndGame.dispose();
                Window_level1 again = new Window_level1(500,500,"Level1",game);
                again.putCharacters();
                again.drawMap();
                again.startTheGame();
            }
